...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cities = {
        ...
        zamalek: { coords: [30.0616, 31.2194], name: 'Zamalek, Cairo', zoom: 13 },
        islamiccairo: { coords: [30.0469, 31.2614], name: 'Islamic Cairo, Egypt', zoom: 13 },
        heliopolis: { coords: [30.0808, 31.3179], name: 'Heliopolis, Cairo', zoom: 13 },
